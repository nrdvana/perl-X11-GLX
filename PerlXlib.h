...
extern SV * PerlXlib_sv_from_display(SV *dest, Display *dpy);
extern SV * PerlXlib_sv_assign_conn(SV *dest, Display *dpy, bool foreign);
extern void PerlXlib_conn_mark_closed(PerlXlib_conn_t *conn);
